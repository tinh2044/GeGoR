...
def main(args, cfg):
    ...
    # Update scheduler config with correct T_max
    ...
    args.device = device  # Add device to args for opt.py
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser("Image DeBluring", parents=[get_args_parser()])
